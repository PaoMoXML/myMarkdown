...
>      
>      2. 使用`MergedAnnotations from(AnnotatedElement element, SearchStrategy searchStrategy)`方法，获取这个元素的`MergedAnnotations（合并注解）` ==MergedAnnotations感觉极其重要，其中方法极其复杂，涉及到spring查找注解==
>
